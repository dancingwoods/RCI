...
\end{Value}
\inputencoding{utf8}
\HeaderA{AssignToPeaks}{Assigns the non-zero pixels of 'region' to one of the maxima of the iamge by hillclimbing on image}{AssignToPeaks}
%
\begin{Description}\relax
...
\end{Value}
\inputencoding{utf8}
\HeaderA{ClusterCells}{Clustering}{ClusterCells}
%
\begin{Description}\relax
Clustering
\end{Description}
